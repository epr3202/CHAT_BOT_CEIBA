...
PREFIX = "docs/audits/2026-09-07-8935687-v0-actions/"
AUDIT_FILES = ("run_ci.py", "ci_driver.py", "audit_db_probes.py", "integrated_flows.py", "product_manifest.json", "provenance.json", "README.md")
...
def main():
    ...
    stage = sys.argv[1]
    if stage not in {"suite", "schema", "reproductions"}:
    ...
    try:
        ...
        allowed = {PREFIX + f for f in AUDIT_FILES} | {".github/workflows/audit-v0.yml"}
        ...
        (root / "Dockerfile").write_text(
            ...
            'ENTRYPOINT ["python", "/audit/ci_driver.py"]\n')
