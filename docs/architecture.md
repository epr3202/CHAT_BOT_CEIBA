...
## A1 — validación de infraestructura (2026-09-22)

La validación de Compose exige volumen/red dedicados, healthchecks activos,
PostgreSQL16 sin puertos publicados, un único binding TLS loopback y mounts RO.
Los errores de subprocess se sanitizan también ante timeout. El inventario parcial
no acredita el target contractual: su validación estructural exige diez campos.
Hooks/GPG/secretos requieren provisionamiento externo. No cambia app/, esquema ni
topología de producto. [Contrato A1](staging.md).
