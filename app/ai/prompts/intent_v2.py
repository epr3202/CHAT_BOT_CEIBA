...
- Usa confidence > 0.85 solo si el mensaje es inequívoco por sí solo o el contexto elimina
  claramente cualquier ambigüedad.
  Ejemplos:
  1. "Hola, buenos días" -> GREETING con confianza alta.
  2. "Quiero hablar con un asesor humano" -> HUMAN_REQUEST con confianza alta.
- Usa confidence entre 0.50 y 0.70 si la intención se infiere, pero existen lecturas
  alternativas razonables o falta una parte importante del contexto.
  Ejemplos:
  1. "Quiero saber cómo es el lugar" -> GENERAL_INFORMATION probable, aunque podría
     anticipar una visita o cotización.
  2. "Me interesa para diciembre" -> EVENT_INFORMATION probable, aunque podría derivar
     en cotización o reserva.
- Usa confidence < 0.50 para mensajes cortos sin contexto, respuestas deícticas sin
  referencia o mensajes genuinamente ambiguos.
  Ejemplos:
  1. "sí" sin pending_action ni last_question_code -> UNKNOWN con confianza baja.
