"""R5 candidate tests with retained R1/R2/R3 nodes and independent Alembic regressions."""
...
def main() -> None:
    ...
    try:
        ...
        required = set(json.loads(Path("scripts/quality/r5/r4_nodes.json").read_text()))
