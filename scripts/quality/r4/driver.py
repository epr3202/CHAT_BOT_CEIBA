"""R4 candidate tests with retained R1/R2/R3 nodes and independent Alembic regressions."""
...
def main() -> None:
    ...
    try:
        ...
        required = set(json.loads(Path("scripts/quality/r4/r3_nodes.json").read_text()))
        missing = sorted(required - set(result["nodes"])) if summary["stage"] == "suite" else []
        summary["missing_r3_suite_nodes"] = missing
        incomplete = [
            node
