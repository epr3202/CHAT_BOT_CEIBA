"""Candidate tests, reporting-only pytest hooks, and the separate R0 regression gate."""
...
import pytest
from isolation import OUT, Isolation
    ...
    def pytest_sessionfinish(self, session: pytest.Session, exitstatus: int) -> None:
        write(
            ...
            dict(
                ...
                schema="Original metadata fixtures; no Alembic migration claim",
            ),
        )
...
def main() -> None:
    ...
    try:
        ...
        os.environ.update(
            ...
            ENVIRONMENT="testing",
            META_APP_SECRET="synthetic-r0",
            META_ACCESS_TOKEN="synthetic-r0",
            OPENROUTER_API_KEY="synthetic-r0",
        ...
        exit_code = int(
            bool(code or lint.returncode or isolation.blocked or not result["collected"])
        )
